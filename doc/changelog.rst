...
* Update for compatibility with Flask 3.
* Update for compatibility with WTForms 3.
...
* Remove the usage of the config `FLASK_ADMIN_SWATCH` (caused by `Admin()` instance's new parameter - `theme`).
